...
def get_restaurant_recommendation(api_key: str, location: str, people: int, genre: str, price: str, notes: str, persona_name: str = "백종원") -> str:
    ...
    if persona_name == "안성재":
        import rest_rec_ahn
        return rest_rec_ahn.recommend_restaurant(location, people, genre, price, notes)
    elif persona_name == "백종원":
        import rest_rec_baik
        return rest_rec_baik.recommend_restaurant(location, people, genre, price, notes)
    else:
        # Fallback or default behavior if needed, currently defaulting to 백종원 as per original code structure implicitly
        import rest_rec_baik
        return rest_rec_baik.recommend_restaurant(location, people, genre, price, notes)
